            ...
            <div class="collapse navbar-collapse" id="navbarcontent">
                <ul class="navbar-nav mt-5 pr-5">
                   <li class="nav-item active">
                       <a href="./index.php" class="button">HOME</span></a>
                   </li>
                   <li class="nav-item">
    ...
    <div class="container" style=" padding-top:200px;"  >
          <div class="row">
             <div class="col-sm offset-md-3 col-md-6">
                  <div class="panel panel-default" style="padding: 10px; color:white; background-color: red; border-radius: 20px;">
            ...
            <p><button class="btn btn-success btn-xs view_data" data-toggle="modal" data-target="#transfer<?php echo $row['user_id'] ?>">Transfer Money</button></p> 
                                   </div>
                                </div>
            </div>
            </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                       ...
                       <div class="form-group row2">
                          <button href="profile.php?user_id=$id" type="submit" id="submit" name="submit" class="btn btn-success btn-md ml-auto">Transfer</button>  
